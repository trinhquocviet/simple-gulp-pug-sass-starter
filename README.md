# SIMPLE GULP, PUG, SASS STARER KIT

Clone from [Pug-Sass Boilerplate Starter Kit](https://github.com/Errec/pug-sass-boilerplate-starter-kit), please take a look to this project first. I have small change in this for me.
...
```bash
$ git clone git@bitbucket.org:trinhquocviet/nikkei-value-search.git <my-project-name>
```
...
* [environment](https://github.com/helloitsdan/gulp-environment) : Config environment to run with custom command.
